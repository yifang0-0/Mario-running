...
class Info:
    ...
    def create_state_labels(self):
        ...
        if self.state == 'main_menu':
           ...
           self.play_image = tools.get_image(setup.GRAPHICS['mario_bros'], 178, 32, 12, 16, (0, 0, 0), C.BG_MULTI)
    ...
    def create_label(self, label, size=40, width_scale=1.25, height_scale=1):
        ...
        laber_image = pygame.transform.scale(label_image, (int(rect.width * width_scale),
