...
class Info():
    ...
    def create_font_image_dict(self):
        ...
        for character, image_rect in zip(character_string, image_rect_list):
            self.image_dict[character] = tool.get_image(setup.GFX['text_images'],
    ...
    def create_player_image(self):
        ...
        if self.game_info[c.PLAYER_NAME] == c.PLAYER_MARIO:
            ...
            rect = (178, 128, 12, 16)
        self.player_image = tool.get_image(setup.GFX['mario_bros'],
                                *rect, (92, 148, 252), 2.9)
    ...
    def create_main_menu_labels(self):
        ...
        self.state_labels = [mario_game, shop, top, top_score,
                            *self.info_labels]
